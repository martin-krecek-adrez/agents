...
| Open | Market Overview laptop-state handoff | Linear DTE-145 / Martin Hapl | Audit is complete. Before cutover, Martin must decide how to handle the stale `peer_tail_pace_summary` input, preserve the genuine unpushed docs, complete the environment contract, and migrate the identified non-rebuildable state. | 2026-07-24 |
