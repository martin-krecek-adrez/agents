...
| dbt Production daily run / Pipeline default | Outlook dbt Cloud / Teams Data pipeline | Open until failure cause and recovery are verified | 2026-06-19 Outlook shows `Production daily run` failed at 06:30 CEST after `dbt build` errored in 21m28s. Teams search shows `Pipeline default` run `scheduled-default-20260619T040030Z` started 06:00 CEST and failed 06:34 CEST; Teams fetch body was empty and no later dbt recovery email was found. | 2026-06-19 |
